...
public class randomSpriteWRaamSmal : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_gameObjects = GameObject.FindGameObjectsWithTag("Raam W smal");
    }

    IEnumerator coroutineRandomColor()
    {
        waitSec = Random.Range(17, 30);
