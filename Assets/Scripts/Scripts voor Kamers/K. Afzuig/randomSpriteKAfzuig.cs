...
public class randomSpriteKAfzuig : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_gameObjects = GameObject.FindGameObjectsWithTag("Afzuig K");
    }

    IEnumerator coroutineRandomColor()
    {
        waitSec = Random.Range(27, 55);
