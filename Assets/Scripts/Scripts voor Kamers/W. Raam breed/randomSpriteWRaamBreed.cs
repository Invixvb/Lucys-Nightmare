...
public class randomSpriteWRaamBreed : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_gameObjects = GameObject.FindGameObjectsWithTag("Raam W breed");
    }

    IEnumerator coroutineRandomColor()
    {
        waitSec = Random.Range(20, 40);
