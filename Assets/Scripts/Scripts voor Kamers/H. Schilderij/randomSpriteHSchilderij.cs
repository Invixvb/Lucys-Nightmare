...
public class randomSpriteHSchilderij : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_gameObjects = GameObject.FindGameObjectsWithTag("Schilderij H");
    }

    IEnumerator coroutineRandomColor()
    {
        waitSec = Random.Range(20, 43);
